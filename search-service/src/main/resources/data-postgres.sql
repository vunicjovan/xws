...
values (1, 69.00, 240, false, 0, 'Opis 1', 'Teslic', 1, 2);
insert into advertisement
(id, price, kilometers_per_day_limit, collision_damage_waiver, rating, description, location, vehicle_id, owner_id)
values (2, 69.00, 220, true, 3.0, 'Opis 2', 'Kovilj', 2, 2);
insert into advertisement
(id, price, kilometers_per_day_limit, collision_damage_waiver, rating, description, location, vehicle_id, owner_id)
values (3, 69.00, 10, true, 4.2, 'Opis 3', 'Sremska Kamenica', 3, 2);
insert into advertisement
(id, price, kilometers_per_day_limit, collision_damage_waiver, rating, description, location, vehicle_id, owner_id)
values (4, 69.00, -1, false, 5.0, 'Opis 4', 'Mala Mostanica', 4, 2);
