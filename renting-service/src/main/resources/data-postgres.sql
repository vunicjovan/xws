...
-- Advertisements
insert into advertisement (id, owner_id) values (1, 3);
insert into advertisement (id, owner_id) values (2, 3);
insert into advertisement (id, owner_id) values (3, 3);
insert into advertisement (id, owner_id) values (4, 3);

-- Renting requests
insert into renting_request (start_date, end_date, sender_id, status) values ('2020-10-21 14:39:06', '2020-10-21 15:38:06', 2, 0);
insert into renting_request (start_date, end_date, sender_id, status) values ('2020-01-21 14:39:06', '2020-01-23 15:38:06', 2, 2);
