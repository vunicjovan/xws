							...
							<md-list-item>
								<div class="md-list-item-text">
									<span>
										...
										<b> Location:</b> <i>{{ ad.location }}</i> <br /><br />
										<i class="fas fa-car"></i>
										<b> Traveled:</b> <i>{{ ad.kmTraveled }} km</i> <br /><br />
										<i class="fas fa-ban"></i>
										<b> Daily travel limit:</b> <i v-if="ad.dailyLimit !== -1">{{ ad.dailyLimit }} km</i><i v-else>None</i> <br /><br />
							...
							<md-list-item>
								<div class="md-list-item-text">
									<span>
										...
										<b> Fuel type:</b> <i>{{ ad.fuel }} </i> <br /><br />
										<i class="fas fa-wrench"></i>
										<b> Gearbox type:</b> <i>{{ ad.gearbox }}</i> <br /><br />
										<i class="fas fa-car-crash"></i>
										<b> Collision damage waiver:</b> <i v-if="ad.cdw">Supported</i><i v-else>Not supported</i> <br /><br />
										<i class="fab fa-android"></i>
										<b> Android:</b> <i v-if="ad.android">Supported</i><i v-else>Not supported</i> <br /><br />
