...
insert into permission (name) values ('GET_UNAPPROVED_COMMENTS')
...
insert into permission (name) values ('LOGGED_IN')
insert into permission (name) values ('GET_AGENTS')
insert into permission (name) values ('REGISTER_AGENTS')
insert into permission (name) values ('POST_RATING')
insert into permission (name) values ('GET_PERSONAL_ADVERTISEMENTS')
